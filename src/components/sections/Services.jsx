          ...
          return (
            <FadeIn key={service.id} delay={100 + index * 100}>
              <div className='group relative bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 h-full flex flex-col'>
                ...
                {/* Hover Overlay */}
                <div className='absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent opacity-0 group-hover:opacity-100 rounded-3xl transition-all duration-300 pointer-events-none' />
              </div>
            </FadeIn>
          );
        })}
          ...
          return (
            <FadeIn key={service.id} delay={300 + index * 100}>
              <div className='group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full'>
                ...
                <div className='absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent opacity-0 group-hover:opacity-100 rounded-2xl transition-all duration-300 pointer-events-none'/>
              </div>
            </FadeIn>
          );
        })}
