...
import { Mail, MapPin, Github, Linkedin, Twitter, Send, MessageSquare, Instagram } from 'lucide-react'
...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
   ...
   setStatus({ type: 'success', message: 'Message sent successfully! I\'ll get back to you as soon as I can. '});
  ...
  return (
    <section id="contact" className="relative py-20 overflow-hidden">
     <div className="absolute inset-0 overflow-hidden">
       ...
       <div className="absolute top-1/2 left-1/2 -translate-x-/1/2 -tranlate-y-1/2 w-96 h-96 bg-primary/10 opacity-30 rounded-full blur-3xl" />
     </div>

     <div className="relative z-10 max-w-full mx:auto px-4 sm:px-4">
       <FadeIn delay={0}>
         <div className="text-center mb-16">
           <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 rounded-full mb-6">
             <MessageSquare className="w-4 h-4 text-primary" />
             <span className="text-sm tet-primary font-medium tracking-wider uppercase">Get In Touch</span>
           </div>

           <h2 className="tet-4xl lg:text-5xl font-normal text-white mb-4">
             Let's Work Together
           </h2>
