    ...
    <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16 sm:mb-20'>
        ...
        <div className='flex flex-col gap-10 sm:gap-12'>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-3 gap-6 sm:gap-8'>
              {ABOUT_STATS.map((stat, index) => (
                <div key={index} className='relative pl-4'>
                  ...
                  <div className='absolute left-0 top-0 w-1 h-full bg-linear-to-b from-primary via-primary/50 to-primary/20 rounded-full'></div>
                  
                  <div className='text-2xl sm:text-3xl font-normal text-white mb-1 font-mono'>
                    {stat.value}
                  </div>
          ...
          <FadeIn>
            <button
              ...
              className='inline-flex items-center gap-3 bg-white hover:bg-white/90 text-black rounded-full px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-medium transition-all duration-300 w-fit group'
            >
        ...
        <FadeIn delay={200}>
         ...
         {/* Bottom Stats Card */}
         <div className='col-span-2 relative group mt-4'>
           <div className='absolute inset-0 bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-300'></div>
         ...
         <div className='flex flex-col items-center gap-8'>
           ...
           <div className='text-center'>
             ...
             <p className='text-sm text-white/60'>
               The tools behind the systems I design and deploy.
             </p>
           </div>
