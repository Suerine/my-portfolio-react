...
// Get proficiency levl
 ...
 const getLevelColor = (level) => {
  const colors = {
   ...
   'Proficient': 'text-cyan-400 bg-cyan-500/20 border-cyan-500/30',
     ...
     <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
      <FadeIn delay={100}>
        ...
        <p className='text-lg text-white/60 max-w-2xl mx-auto'>
          A structured overview of the technologies I use to design and ship scalable systems.
        </p>
        </div>
      </FadeIn>
